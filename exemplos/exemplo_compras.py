...
otimizacao_emilio.adicionar_restricao(' x_1 + x_2 + x_3 + x_4  == 20')
...
otimizacao_emilio.simplex(calculo_visivel=True)


# VERSAO FLP
# otimizacao_emilio = Otimizador()
# otimizacao_emilio.adicionar_funcao_objetivo('max. + 0x_1 +  0x_3 + 0x_2 + 0x_4 + x_5')
# otimizacao_emilio.adicionar_restricao('+ 3000x_1  + 30000x_3 + 20000x_2 + 10000x_4 + 37777x_5 <= 137777')
# otimizacao_emilio.adicionar_restricao('+ x_1 +  x_3 + x_2 + 1x_4 + 5x_5 == 25')
...
# otimizacao_emilio.simplex(calculo_visivel=True)
# print(otimizacao_emilio.simplex(calculo_visivel=True))