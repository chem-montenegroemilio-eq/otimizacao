...
Este projeto foi desenvolvido para aprendizado e ensino do funcionamento interno do método Simplex, de fácil uso e implementação.

### Instalação

Instala diretamente do GitHub via:
